...
export default function CheckoutPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (!usernameValidation.valid) {
      setError("Неверный ник игрока. Вернитесь в корзину и исправьте.");
      return;
    }
    if (!agreed) {
      setError("Необходимо принять условия сервиса");
      return;
    }
    ...
    try {
      ...
      // data.paymentUrl would come from payment provider
      clearCart();
            ...
            <div className="lg:col-span-2 space-y-6">
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-xs" style={{ color: "#7b87a8" }}>
                      Minecraft ник — привилегии будут выданы этому игроку
                    </div>
                  </div>
                  <Link
                    href="/cart"
              ...
              >
                <label className="flex items-start gap-3 cursor-pointer">
                  <div
                    ...
                    style={{
                      background: agreed ? "linear-gradient(135deg, #6c63ff, #4facfe)" : "transparent",
                      border: agreed ? "none" : "2px solid rgba(108,99,255,0.4)",
                    }}
                  ...
                  <span className="text-sm" style={{ color: "#a8b4d8" }}>
                    Я соглашаюсь с{" "}
                    <Link href="/rules" style={{ color: "#6c63ff" }}>
                      правилами сервера
                    </Link>{" "}
                    и подтверждаю, что цифровые товары не подлежат возврату после
                    активации.
                  </span>
                </label>
              </div>
              ...
              {error && (
                ...
                >
                  ...
                  <span className="text-sm" style={{ color: "#fc8181" }}>
                    {error}
                  </span>
                </div>
              )}
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    boxShadow:
                      !loading && agreed ? "0 6px 20px rgba(108,99,255,0.4)" : "none",
                  }}
                >
                  {loading ? (
                    <>
