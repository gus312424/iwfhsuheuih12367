      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-12">
          ...
          <p style={{ color: "#7b87a8" }}>
            Как связать Minecraft-сервер с сайтом так, чтобы покупки, онлайн, ранги и валюта работали в реальном времени.
          </p>
        </div>
        ...
        <section className="mb-10">
          ...
          >
            <p style={{ color: "#a8b4d8" }}>
              ...
              <span className="font-bold" style={{ color: "#e8eaf6" }}>RCON/HTTP к серверу</span> → выдаётся ранг/валюта/кейс.
            </p>
          </div>
        </section>
        ...
        <section className="mb-10">
          ...
          >
            ...
            >
              ...
              <div className="mt-2" style={{ color: "#7b87a8" }}>{"//"} Выдача донат-валюты (плагин Vault/Economy)</div>
              <div>{`eco give <НИК> <сумма>`}</div>
              <div style={{ color: "#ffd700" }}>{`eco give Steve 300`}</div>
        ...
        <section className="mb-10">
          ...
          >
            ...
            >
              ...
              <div>https://api.mcsrvstat.us/3/<span style={{ color: "#68d391" }}>play.vexium.ru</span></div>
        ...
        >
          <p className="text-sm mb-4" style={{ color: "#a8b4d8" }}>
            Нужна помощь с настройкой? Напиши администратору в Discord.
          </p>
