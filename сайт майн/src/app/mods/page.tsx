      ...
      <div className="max-w-4xl mx-auto">
        ...
        >
          ...
          <div className="space-y-3">
            {[
              ...
              },
              {
                ...
                a: "Проверь IP — mc.vexium.ru без порта. Если не помогает — сервер временно недоступен, попробуй позже.",
              },
            ].map((item, i) => (
          ...
          <div className="mt-6 pt-4 border-t flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3" style={{ borderColor: "rgba(108,99,255,0.1)" }}>
            <span className="text-sm" style={{ color: "#7b87a8" }}>Остались вопросы? Напиши на почту</span>
            <Link
              href="/contact"
